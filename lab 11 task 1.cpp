...
int main()
{
    ...
    cout << "Enter a message: ";   // user ko message enter karne ko keh rahe hain
    cin.get(message, 100);         // full line input le raha hai (spaces ke sath)

    cout << "You entered: " << message << endl;  // input print kar raha hai
